####################################################################
# Файл с утилитами, необходимыми для работы с датасетом.           #
# Взяты с этого источника (https://github.com/CSAILVision/ADE20K/) # 
####################################################################
...
def loadAde20K(file):
    ...
    # Получение сегментированной маски, сделанной из RGB канала _seg файла
    R = seg[:,:,0];
    G = seg[:,:,1];
    B = seg[:,:,2];
    ...
    # Получение синей маски примера из _seg файла
